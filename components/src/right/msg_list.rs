...
use web_sys::{
    Blob, BlobPropertyBag, HtmlAudioElement, HtmlDivElement, HtmlElement, IntersectionObserverInit,
    Url,
};
...
const MSG_LIST_MAX_LEN: usize = 50;
...
impl Component for MessageList {
    ...
    fn view(&self, ctx: &Context<Self>) -> Html {
        ...
        let list = self.get_list_html(ctx);
